...
import rayan.rayanapp.ViewHolders.DeviceViewHolderRemoteHub;

public class DevicesRecyclerViewAdapter
//        extends GenericRecyclerViewAdapter<Device, OnDeviceClickListener<Device>, DeviceViewHolder1Bridge> {
{
//
...
//        else
//            return new DeviceViewHolderRemoteHub(inflate(R.layout.item_device_remote_hub, parent));
//    }
//
//
//        @Override
...
//            return 2;
//        else if (device.getType().equals(AppConstants.DEVICE_TYPE_PLUG))
//            return 3;
//        else return 4;
//    }

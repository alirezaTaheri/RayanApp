...
public class SetPrimaryConfigRequest extends BaseRequest{
    ...
    public SetPrimaryConfigRequest(String ssid, String pwd, String hostname, String mqtthost, String mqttSslPort, String mqttTcpPort, String mqtttopic, String mqttuser, String mqttpass, String style, String secret) {
        this.ap_ssid = ssid;
        this.ap_pass = pwd;

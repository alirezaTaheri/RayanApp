...
//                            Toast.makeText(rayanApplication, "Command Attached", Toast.LENGTH_SHORT).show();
    ...
    private Observable<Response<ToggleDeviceResponse>> toDeviceHttpPin1(Device device, boolean on) throws UnsupportedEncodingException, NoSuchAlgorithmException, InvalidKeyException {
        return apiService.togglePin1(sha1(new ToggleDevice(on? AppConstants.ON_1 : AppConstants.OFF_1,Encryptor.encrypt(device.getStatusWord().concat("#"), device.getSecret())).ToString(), device.getSecret()),AppConstants.getDeviceAddress(device.getIp()), new ToggleDevice(on? AppConstants.ON_1 : AppConstants.OFF_1,Encryptor.encrypt(device.getStatusWord().concat("#"), device.getSecret())))
                .observeOn(Schedulers.io()).subscribeOn(Schedulers.io());
    }
    @SuppressLint("CheckResult")
    private Observable<ToggleDeviceResponse> toDeviceHttpPin1Pin2(Device device){
        String stword = Encryptor.encrypt(device.getStatusWord().concat("#"), device.getSecret());
//        return apiService.togglePin1Pin2(AppConstants.getDeviceAddress(device.getIp()), new ToggleDeviceWithLastCommand(AppConstants.ON_1)).observeOn(Schedulers.io()).subscribeOn(Schedulers.io());
        if (device.getPin1().equals(AppConstants.ON_STATUS) && device.getPin2().equals(AppConstants.ON_STATUS))
            return apiService.togglePin1Pin2(AppConstants.getDeviceAddress(device.getIp()), new ToggleDeviceWithLastCommand(AppConstants.ON_1,stword, AppConstants.ON_2)).observeOn(Schedulers.io()).subscribeOn(Schedulers.io());
        else if (device.getPin1().equals(AppConstants.ON_STATUS) && device.getPin2().equals(AppConstants.OFF_STATUS))
            return apiService.togglePin1Pin2(AppConstants.getDeviceAddress(device.getIp()), new ToggleDeviceWithLastCommand(AppConstants.ON_1,stword, AppConstants.OFF_2)).observeOn(Schedulers.io()).subscribeOn(Schedulers.io());
        else if (device.getPin1().equals(AppConstants.OFF_STATUS) && device.getPin2().equals(AppConstants.ON_STATUS))
            return apiService.togglePin1Pin2(AppConstants.getDeviceAddress(device.getIp()), new ToggleDeviceWithLastCommand(AppConstants.OFF_1,stword, AppConstants.ON_2)).observeOn(Schedulers.io()).subscribeOn(Schedulers.io());
        else if (device.getPin1().equals(AppConstants.OFF_STATUS) && device.getPin2().equals(AppConstants.OFF_STATUS))
            return apiService.togglePin1Pin2(AppConstants.getDeviceAddress(device.getIp()), new ToggleDeviceWithLastCommand(AppConstants.OFF_1,stword, AppConstants.OFF_2)).observeOn(Schedulers.io()).subscribeOn(Schedulers.io());
        return null;
    }

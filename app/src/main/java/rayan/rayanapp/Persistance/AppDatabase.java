...
@Database(entities = {Device.class, RemoteHub.class, Remote.class, Group.class, User.class,UserMembership.class, LocallyChange.class, Scenario.class}, version = 1, exportSchema = false)

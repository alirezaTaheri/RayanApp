...
public interface WifiHelper {
     ...
     */
    boolean enableConnected(final String ssid, WifiCypherType.WifiCipherType type, String... password);
     ...
     * @return whether the connection is started
     */
    boolean enableConnected(final String ssid, WifiCypherType.WifiCipherType type, boolean isSsidHidden, String... password);

    /**
     * @deprecated Use {@link #connect(String, WifiCipherType.WifiCipherType, boolean, String...)} instead of it,
     * and the isSsidHidden=false when you call the method
     *
     * if the wifi is conneted to AP return true directly, otherwise connect to AP with WifiConfiguration saved by
     ...
     * @throws InterruptedException when connect is interrupted
     */
    boolean connect(final String ssid, WifiCypherType.WifiCipherType type, String... password)
            throws InterruptedException;
     ...
     * @throws InterruptedException when connect is interrupted
     */
    boolean connect(final String ssid, WifiCypherType.WifiCipherType type, boolean isSsidHidden, String... password)
            throws InterruptedException;

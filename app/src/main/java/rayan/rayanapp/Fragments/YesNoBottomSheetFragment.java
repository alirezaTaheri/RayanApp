...
public class YesNoBottomSheetFragment extends BottomSheetDialogFragment {
   ...
   private String tag;
    ...
    public static YesNoBottomSheetFragment instance(String tag, String submitTxt, String cancelTxt, String sheetTxt) {
        final YesNoBottomSheetFragment fragment = new YesNoBottomSheetFragment();

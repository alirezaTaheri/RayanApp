...
public class RemoveAdminButtomSheetFragment extends BottomSheetDialogFragment {
    private String id;
    ...
    public static RemoveAdminButtomSheetFragment newInstance(String idd,String groupIdd ) {
        final RemoveAdminButtomSheetFragment fragment = new RemoveAdminButtomSheetFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        submitBtn.setText("حذف مدیر گروه");
        cancelBtn.setText("بازگشت");
        bottomSheetText.setText("آیا مایل به حذف مدیر گروه هستید؟");
    ...
    void clickOnSubmit(){
        editGroupFragmentViewModel.deleteAdmin(id, groupId).observe(this, baseResponse -> {
